...
const colors = [
    "rgba(108,9,232,0.5)",
    "rgba(145, 255, 255, 0.5)",
    "rgba(77,243,12,0.5)",
    "rgba(21,90,234,0.5)",
    "rgba(239,58,4,0.5)",
    "rgba(255,240,145,0.5)",
    "rgba(255,145,174,0.5)",
    "rgba(215,145,255,0.5)",
    "rgba(200,255,145,0.5)",
]
    ...
    return (
        <div ref={ref} className="screen m-screen">
            <div id="message-bubble" className="message bubble">
                <p className='profile-image'><img src={userData?.profileImage || DEFAULT_PROFILE_IMAGE} /></p>
                <div className='text' style={GetColor()} >
                    <p className='username'>{userData?.username || "Aviya"}</p>
